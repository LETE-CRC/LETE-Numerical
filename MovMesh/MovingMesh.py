...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 17:23:30 2015 by helio
Modified on Tue Oct 17 18:50:33 2017 by filipi
...
final1 += '\n--------------- Solução em X ----------------\n\n'
final2 = '\n============================================='
print (final1 + str(DeslocamentoV) + final2)
...
print ('ACABOOOOU, É TETRAAAAAAAAAAAAAAA')
